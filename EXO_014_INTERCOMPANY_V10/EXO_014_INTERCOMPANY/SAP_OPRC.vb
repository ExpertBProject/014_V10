...
#Region "Inicialización"
    ...
    Public Overrides Function filtros() As SAPbouiCOM.EventFilters
        Dim fXML As String = objGlobal.Functions.leerEmbebido(Me.GetType(), "Filtros_OPRC.xml")
                        ...
                        Select Case infoEvento.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE
                                If infoEvento.ActionSuccess Then
                                    ...
                                    sCodigo = oXml.SelectSingleNode("ProfitCenterParams/CenterCode").InnerText

                                    If GuardarInterCoOPRC("2", "OPRC", sCodigo) = False Then
                                        Return False
                                    End If
                                End If
...
#Region "Métodos auxiliares"
    ...
    Private Function GuardarInterCoOPRC(ByVal sTableCategory As String, ByVal sTableName As String, ByVal sCodigo As String) As Boolean
            ...
            If EXO_GLOBALES.EmpresaConectadaEsMatriz(objGlobal) = True Then
                ...
                If oRs.RecordCount > 0 Then
                    For i As Integer = 0 To oNodes.Count - 1
                        ...
                        oRsAux.DoQuery("SELECT PrcCode AS Codigo " & _
                                       "FROM " & sTableName & " WITH (NOLOCK) " & _
                                       "WHERE PrcCode = '" & sCodigo & "'")
