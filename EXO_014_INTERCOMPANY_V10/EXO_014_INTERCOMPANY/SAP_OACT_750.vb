        ...
        Try
            ...
            If pVal.ItemUID = "1" Then
                If pVal.ActionSuccess Then
                    If GuardarInterCoOACT("4", "OACT") = False Then
                        Exit Function
                    End If
                End If
            End If
...
#Region "Métodos auxiliares"
    ...
    Private Function GuardarInterCoOACT(ByVal sTableCategory As String, ByVal sTableName As String) As Boolean
        ...
        Try
            If EXO_GLOBALES.EmpresaConectadaEsMatriz(objGlobal) = True Then
                ...
                If oRs.RecordCount > 0 Then
                    ...
                    oRsAux2.DoQuery("DELETE FROM [INTERCOMPANY].dbo.[REPLICATE] WHERE tableName = '" & sTableName & "' AND codeTable NOT IN (SELECT AcctCode " & _
                    ...
                    For i As Integer = 0 To oNodes.Count - 1
                        ...
                        oRsAux.DoQuery("SELECT AcctCode AS Codigo " & _
                                       ...
                                       "WHERE CreateDate = '" & Now.Year & "-" & Right("0" & Now.Month.ToString, 2) & "-" & Right("0" & Now.Day.ToString, 2) & "' " & _
                                       "OR UpdateDate = '" & Now.Year & "-" & Right("0" & Now.Month.ToString, 2) & "-" & Right("0" & Now.Day.ToString, 2) & "'")
