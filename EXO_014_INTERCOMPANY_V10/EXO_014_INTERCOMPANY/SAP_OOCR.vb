            ...
            If infoEvento.BeforeAction = True Then
                Select Case infoEvento.MenuUID
                    Case "1283"
                        ...
                        If oForm.TypeEx = "811" Then
                            _sCodigo = CType(oForm.Items.Item("5").Specific, SAPbouiCOM.EditText).Value
                        End If
                End Select
            End If
                        ...
                        Select Case infoEvento.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE
                                If infoEvento.ActionSuccess Then
                                    If GuardarInterCoOOCR("3", "OOCR", _sCodigo) = False Then
                                        Return False
                                    End If
                                End If
...
#Region "Métodos auxiliares"
    ...
    Private Function GuardarInterCoOOCR(ByVal sTableCategory As String, ByVal sTableName As String, ByVal sCodigo As String) As Boolean
            ...
            If EXO_GLOBALES.EmpresaConectadaEsMatriz(objglobal) = True Then
                ...
                If oRs.RecordCount > 0 Then
                    For i As Integer = 0 To oNodes.Count - 1
                        ...
                        oRsAux.DoQuery("SELECT OcrCode AS Codigo " &
                                       "FROM " & sTableName & " WITH (NOLOCK) " &
                                       "WHERE OcrCode = '" & sCodigo & "' " &
                                       "AND Direct = 'N'")
