...
#Region "Inicialización"
    ...
    Public Overrides Function filtros() As SAPbouiCOM.EventFilters
        Dim fXML As String = objGlobal.funciones.leerEmbebido(Me.GetType(), "Filtros_OFRT.xml")
        ...
        Try
            If infoEvento.BeforeAction = True Then
                Select Case infoEvento.FormTypeEx
                    Case "700", "701", "702", "540020000", "80021"
                        ...
                        Select Case infoEvento.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE
                                If infoEvento.ActionSuccess Then
                                    If GuardarInterCoOFRT("5") = False Then
                                        Return False
                                    End If
                                End If
...
#Region "Métodos auxiliares"
    ...
    Private Function GuardarInterCoOFRT(ByVal sTableCategory As String) As Boolean
                    ...
                    For i As Integer = 0 To oNodes.Count - 1
                        ...
                        If oRsAux2.RecordCount = 0 Then
                            ...
                            oRsAux2.DoQuery("INSERT INTO [INTERCOMPANY].dbo.[REPLICATE] (dbNameOrig, dbNameDest, tableCategory, tableName, codeTable, dateAdd) VALUES " &
                                            ...
                                            ", " & sTableCategory & ", 'MODFINAN', '-1', '" & dFecha.ToShortDateString & "')")
                        End If
