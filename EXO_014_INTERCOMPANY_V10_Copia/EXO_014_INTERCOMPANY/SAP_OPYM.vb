...
#Region "Inicialización"
    ...
    Public Overrides Function filtros() As SAPbouiCOM.EventFilters
        Dim fXML As String = objGlobal.funciones.leerEmbebido(Me.GetType(), "Filtros_OPYM.xml")
                        ...
                        Select Case infoEvento.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE
                                If infoEvento.ActionSuccess Then
                                    ...
                                    sCodigo = oXml.SelectSingleNode("WizardPaymentMethodParams/PaymentMethodCode").InnerText

                                    If GuardarInterCoOPYM("2", "OPYM", sCodigo) = False Then
                                        Return False
                                    End If
                                End If
...
#Region "Métodos auxiliares"
    ...
    Private Function GuardarInterCoOPYM(ByVal sTableCategory As String, ByVal sTableName As String, ByVal sCodigo As String) As Boolean
            ...
            If EXO_GLOBALES.EmpresaConectadaEsMatriz(objglobal) = True Then
                ...
                If oRs.RecordCount > 0 Then
                    For i As Integer = 0 To oNodes.Count - 1
                        ...
                        oRsAux.DoQuery("SELECT PayMethCod AS Codigo, Type Codigo2 " &
                                       "FROM " & sTableName & " WITH (NOLOCK) " &
                                       "WHERE PayMethCod = '" & sCodigo & "'")
                        ...
                        If oRsAux.RecordCount > 0 Then
                            ...
                            If oRsAux2.RecordCount = 0 Then
                                ...
                                oRsAux2.DoQuery("INSERT INTO [INTERCOMPANY].dbo.[REPLICATE] (dbNameOrig, dbNameDest, tableCategory, tableName, codeTable, codeTable2, dateAdd) VALUES " &
                                                ...
                                                ", " & sTableCategory & ", '" & sTableName & "', '" & sCodigo & "', '" & oRsAux.Fields.Item("Codigo2").Value.ToString & "', '" & dFecha.ToShortDateString & "')")
                            End If
                        Else
